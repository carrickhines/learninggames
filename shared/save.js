...
var Save = (function () {
  ...
  var STORY_CARDS = [
    ...
    { id: 's-tortoise', name: 'The Old Judge', emoji: '⚖️' },
    { id: 's-forecast', name: 'The Forecaster', emoji: '🌦️' },
    { id: 's-baker',   name: 'The Ribbon Baker', emoji: '🥐' },
    { id: 's-keeper',  name: 'The Keeper of Lost Things', emoji: '🧦' },
